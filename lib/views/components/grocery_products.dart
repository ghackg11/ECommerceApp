...
class _GroceryProductsState extends State<GroceryProducts> {
  ...
  GrocieriesProductController groceryProductController = Get.find();
  ...
  void _scrollListener() {
    if (scrollController.offset >= scrollController.position.maxScrollExtent &&
      ...
      groceryProductController.fetchMoreData();
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetX<GrocieriesProductController>(builder: (controller) {
